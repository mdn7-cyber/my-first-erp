...
<div class="wrapper row4 bgded overlay" style="background-image:url('images/demo/backgrounds/02.png');">
  ...
  <footer id="footer" class="hoc clear"> 
   <div class="one_half first">
      ...
      <p>This Webiste is Specifically for all the Oriental group faculty as well as students.</p>
          </div>
      <div class="one_half">
      ...
      <ul class="nospace btmspace-30 linklist contact">
        <li><i class="fa fa-map-marker"></i>
          <address>
              <p>Oriental Group</p>
              <p>Oriental Campus, Opp Patel Nagar, Raisen Road, Bhopal (M.P.) 462022.</p>
          </address>
        </li>
        <li><i class="fa fa-phone"></i> 755 2529472 (Bhopal Campus)</li>
        <li><i class="fa fa-fax"></i>  2234 1389 (Indore Campus)</li>
        <li><i class="fa fa-envelope-o"></i>https://oriental.ac.in/</li>
      </ul>
